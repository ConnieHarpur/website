...
**Abstract:** *Glaciers that flow into lakes are known to lose mass more rapidly than those that terminate on land. Although the Greenland Ice Sheet is surrounded by more than 2000 ice-marginal lakes, a lack of research into their effects on ice dynamics mean that they remain excluded from models of ice sheet change, reducing the accuracy of sea level predictions. This study aims to explore the impact of ice-marginal lakes on the velocity of Greenlandic outlet glaciers. Using NASA ITS_LIVE data, we compare patterns of ice surface velocity at 103 pairs of neighbouring lake- and land-terminating glaciers during the years 2015 to 2022. The flow regime of each glacier was characterised by sampling the average velocity at equidistant locations along each glacier trunk. Whilst the land-terminating glaciers decelerate towards the terminus, the lake-terminating glaciers maintain high flow speeds along their lengths. This trend is both spatially and temporally consistent and suggests that ice-marginal lakes enhance the flow of outlet glaciers in Greenland, delivering more ice to the ice sheet edge. This highlights the need for further research into lake-ice interactions, so that they can be accounted for in projections of Greenland’s future ice loss.* 
